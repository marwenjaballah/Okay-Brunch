...
('Shakshuka', 'Eggs poached in spiced tomato sauce with warm pita bread', 15.99, 'Specialties', '/placeholder.svg?height=300&width=300'),
('Berry Smoothie Bowl', 'Granola, coconut, honey, and fresh berries over acai smoothie', 12.99, 'Bowls', '/placeholder.svg?height=300&width=300'),
('Huevos Rancheros', 'Fried eggs, black beans, salsa, and queso fresco on crispy tortillas', 14.99, 'Mexican', '/placeholder.svg?height=300&width=300');
